      ...
      <div className="w-full lg:w-[1024px] m-auto">
        ...
        <CardPrimary className="mt-6">
          <div className="w-full mt-4">
            {user ? (
              <div className="mb-2">
                <Typography.Paragraph className="font-semibold mb-2">Ready to join?</Typography.Paragraph>
                {user?.user?.name}
              </div>
            ) : (
              <div className="mb-4">
                <Typography.Paragraph className="font-semibold mb-2">What&apos;s your name?</Typography.Paragraph>
